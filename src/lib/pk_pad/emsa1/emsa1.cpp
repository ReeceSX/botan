...
secure_vector<uint8_t> emsa1_encoding(const secure_vector<uint8_t> &msg, size_t output_bits)
{
...
secure_vector<uint8_t> EMSA1::encoding_of(const secure_vector<uint8_t> &msg, size_t output_bits,
...
bool EMSA1::verify(const secure_vector<uint8_t> &input, const secure_vector<uint8_t> &raw, size_t key_bits)
{
...
AlgorithmIdentifier EMSA1::config_for_x509(const Private_Key &key, const std::string &cert_hash_name) const
{
