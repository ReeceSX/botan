 ...
 */
secure_vector<uint8_t> EMSA_X931::encoding_of(const secure_vector<uint8_t> &msg, size_t output_bits,
 ...
 */
bool EMSA_X931::verify(const secure_vector<uint8_t> &coded, const secure_vector<uint8_t> &raw, size_t key_bits)
{
    try
    {
