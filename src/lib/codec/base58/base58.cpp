...
class Character_Table
{
  public:
    ...
    Character_Table(const char *alphabet) : m_alphabet(alphabet)
    {
...
template <typename T, typename Z> size_t count_leading_zeros(const T input[], size_t input_length, Z zero)
{
