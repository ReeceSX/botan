...
extern "C"
{
    ...
    {
        return BOTAN_FFI_RETURNING(Botan::BlockCipher, bc, b, { return static_cast<int>(b.block_size()); });
    }
    ...
    int botan_block_cipher_name(botan_block_cipher_t cipher, char *name, size_t *name_len)
    {
        ...
        return BOTAN_FFI_DO(Botan::BlockCipher, cipher, bc, { return write_str_output(name, name_len, bc.name()); });
    }
