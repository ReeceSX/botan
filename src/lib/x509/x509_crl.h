...
class BOTAN_PUBLIC_API(2, 0) X509_CRL final : public X509_Object
{
  public:
    ...
    {
      public:
        explicit X509_CRL_Error(const std::string &error) : Decoding_Error("X509_CRL: " + error)
        {
        }
    };
     ...
     */
    X509_CRL(const X509_DN &issuer, const X509_Time &thisUpdate, const X509_Time &nextUpdate,
