...
std::shared_ptr<const X509_Certificate> Flatfile_Certificate_Store::find_cert_by_pubkey_sha1(
...
std::shared_ptr<const X509_Certificate> Flatfile_Certificate_Store::find_cert_by_raw_subject_dn_sha256(
