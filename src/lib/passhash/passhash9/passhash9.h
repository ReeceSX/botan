 ...
 */
std::string BOTAN_PUBLIC_API(2, 0) generate_passhash9(const std::string &password, RandomNumberGenerator &rng,
 ...
 */
bool BOTAN_PUBLIC_API(2, 0) check_passhash9(const std::string &password, const std::string &hash);
