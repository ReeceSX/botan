...
std::string generate_passhash9(const std::string &pass, RandomNumberGenerator &rng, uint16_t work_factor,
                               uint8_t alg_id)
{
...
bool check_passhash9(const std::string &pass, const std::string &hash)
{
    ...
    secure_vector<uint8_t> cmp = kdf.derive_key(PASSHASH9_PBKDF_OUTPUT_LEN, pass, &bin[ALGID_BYTES + WORKFACTOR_BYTES],
