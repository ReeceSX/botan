...
BOTAN_FUNC_ISA("ssse3")
void aes_192_key_expansion(__m128i *K1, __m128i *K2, __m128i key2_with_rcon, uint32_t out[], bool last)
{
    __m128i key1 = *K1;
    __m128i key2 = *K2;
...
#define AES_192_key_exp(RCON, EK_OFF)                                                                                  \
    aes_192_key_expansion(&K0, &K1, _mm_aeskeygenassist_si128(K1, RCON), &m_EK[EK_OFF], EK_OFF == 48)
