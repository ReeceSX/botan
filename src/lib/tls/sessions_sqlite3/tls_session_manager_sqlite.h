 ...
 */
class BOTAN_PUBLIC_API(2, 0) Session_Manager_SQLite final : public Session_Manager_SQL
{
  public:
    /**
    ...
    */
    Session_Manager_SQLite(const std::string &passphrase, RandomNumberGenerator &rng, const std::string &db_filename,
