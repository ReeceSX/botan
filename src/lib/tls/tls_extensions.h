...
class BOTAN_UNSTABLE_API Server_Name_Indicator final : public Extension
{
  public:
    ...
    explicit Server_Name_Indicator(const std::string &host_name) : m_sni_host_name(host_name)
    {
    }
...
class BOTAN_UNSTABLE_API SRP_Identifier final : public Extension
{
  public:
    ...
    explicit SRP_Identifier(const std::string &identifier) : m_srp_identifier(identifier)
    {
    }

    SRP_Identifier(TLS_Data_Reader &reader, uint16_t extension_size);
...
class BOTAN_UNSTABLE_API Application_Layer_Protocol_Notification final : public Extension
{
  public:
     ...
     */
    explicit Application_Layer_Protocol_Notification(const std::string &protocol) : m_protocols(1, protocol)
    {
    }
     ...
     */
    explicit Application_Layer_Protocol_Notification(const std::vector<std::string> &protocols) : m_protocols(protocols)
    {
    }
...
class BOTAN_UNSTABLE_API Session_Ticket final : public Extension
{
  public:
     ...
     */
    explicit Session_Ticket(const std::vector<uint8_t> &session_ticket) : m_ticket(session_ticket)
    {
    }
...
class BOTAN_UNSTABLE_API Signature_Algorithms final : public Extension
{
  public:
    ...
    explicit Signature_Algorithms(const std::vector<Signature_Scheme> &schemes) : m_schemes(schemes)
    {
    }
