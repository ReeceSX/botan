 ...
 */
std::vector<uint8_t> finished_compute_verify(const Handshake_State &state, Connection_Side side)
{
    const uint8_t TLS_CLIENT_LABEL[] = {0x63, 0x6C, 0x69, 0x65, 0x6E, 0x74, 0x20, 0x66,
                                        0x69, 0x6E, 0x69, 0x73, 0x68, 0x65, 0x64};

    const uint8_t TLS_SERVER_LABEL[] = {0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x20, 0x66,
                                        0x69, 0x6E, 0x69, 0x73, 0x68, 0x65, 0x64};
 ...
 */
Finished::Finished(Handshake_IO &io, Handshake_State &state, Connection_Side side)
 ...
 */
bool Finished::verify(const Handshake_State &state, Connection_Side side) const
{
