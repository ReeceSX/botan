...
class BOTAN_PUBLIC_API(2, 0) AutoSeeded_RNG final : public RandomNumberGenerator
{
  public:
    ...
    size_t reseed(Entropy_Sources &srcs, size_t poll_bits = BOTAN_RNG_RESEED_POLL_BITS,
     ...
     * the RNG will be called before automatic reseeding is performed
     */
    AutoSeeded_RNG(RandomNumberGenerator &underlying_rng, Entropy_Sources &entropy_sources,
