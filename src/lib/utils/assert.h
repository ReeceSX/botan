 ...
 */
BOTAN_NORETURN void BOTAN_UNSTABLE_API throw_invalid_argument(const char *message, const char *func, const char *file);
 ...
 */
BOTAN_NORETURN void BOTAN_UNSTABLE_API throw_invalid_state(const char *message, const char *func, const char *file);
...
#define BOTAN_UNUSED(...)                                                                                              \
    _BOTAN_UNUSED_GET_IMPL(__VA_ARGS__, _BOTAN_UNUSED_IMPL9, _BOTAN_UNUSED_IMPL8, _BOTAN_UNUSED_IMPL7,                 \
                           _BOTAN_UNUSED_IMPL6, _BOTAN_UNUSED_IMPL5, _BOTAN_UNUSED_IMPL4, _BOTAN_UNUSED_IMPL3,         \
                           _BOTAN_UNUSED_IMPL2, _BOTAN_UNUSED_IMPL1, unused dummy rest value)                          \
