 ...
 */
template <typename T> inline T expand_top_bit(T a)
{
 ...
 */
template <typename T> inline T ct_is_zero(T x)
{
 ...
 */
template <typename T> inline constexpr bool is_power_of_2(T arg)
{
 ...
 */
template <typename T> inline size_t high_bit(T n)
{
    size_t hb = 0;
 ...
 */
template <typename T> inline size_t significant_bytes(T n)
{
    size_t b = 0;
 ...
 */
template <typename T> inline size_t ctz(T n)
{
    /*
...
template <typename T> uint8_t ceil_log2(T x)
{
...
template <typename T> inline T bit_permute_step(T x, T mask, size_t shift)
{
    /*
...
template <typename T> inline void swap_bits(T &x, T &y, T mask, size_t shift)
{
