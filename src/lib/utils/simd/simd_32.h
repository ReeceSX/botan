...
class SIMD_4x32 final
{
  public:
     ...
     */
    template <size_t ROT1, size_t ROT2, size_t ROT3> SIMD_4x32 rho() const
    {
     ...
     */
    template <size_t ROT> SIMD_4x32 rotl() const
    {
     ...
     */
    template <size_t ROT> SIMD_4x32 rotr() const
    {
    ...
    template <size_t I> SIMD_4x32 shift_elems_left() const
    {
    ...
    template <size_t I> SIMD_4x32 shift_elems_right() const
    {
        static_assert(I <= 3, "Invalid shift count");
