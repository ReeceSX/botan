...
class BOTAN_UNSTABLE_API CurveGFp_Repr
{
  public:
    ...
    virtual void curve_mul_words(BigInt &z, const word x_words[], const size_t x_size, const BigInt &y,
...
template <> inline void swap<Botan::CurveGFp>(Botan::CurveGFp &curve1, Botan::CurveGFp &curve2) noexcept
{
    curve1.swap(curve2);
}
