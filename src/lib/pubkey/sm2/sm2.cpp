...
SM2_PrivateKey::SM2_PrivateKey(const AlgorithmIdentifier &alg_id, const secure_vector<uint8_t> &key_bits)
...
{
  public:
    SM2_Signature_Operation(const SM2_PrivateKey &sm2, const std::string &ident, const std::string &hash)
...
{
  public:
    SM2_Verification_Operation(const SM2_PublicKey &sm2, const std::string &ident, const std::string &hash)
...
void parse_sm2_param_string(const std::string &params, std::string &userid, std::string &hash)
{
...
std::unique_ptr<PK_Ops::Verification> SM2_PublicKey::create_verification_op(const std::string &params,
