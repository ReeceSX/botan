...
template <size_t S, int64_t MUL = 1> inline void carry(int64_t &h0, int64_t &h1)
{
...
template <size_t S> inline void carry0(int64_t &h0, int64_t &h1)
{
    static_assert(S > 0 && S < 64, "Shift in range");
...
template <size_t S> inline void carry0(int32_t &h0, int32_t &h1)
{
