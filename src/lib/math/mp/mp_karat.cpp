...
template <size_t SZ> inline bool sized_for_comba_sqr(size_t x_sw, size_t x_size, size_t z_size)
{
...
void bigint_mul(word z[], size_t z_size, const word x[], size_t x_size, size_t x_sw, const word y[], size_t y_size,
                size_t y_sw, word workspace[], size_t ws_size)
{
    clear_mem(z, z_size);
