 ...
 * @param so_pin PIN of the security officer. Will be set if the token is uninitialized other this has to be the current
 * SO_PIN
...
class BOTAN_PUBLIC_API(2, 0) LowLevel
{
  public:
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li CantLock \li
     * CryptokiAlreadyInitialized \li FunctionFailed \li GeneralError \li HostMemory \li NeedToCreateThreads \li OK
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li FunctionFailed \li GeneralError \li HostMemory \li OK
     * @return true on success, false otherwise
     */
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li FunctionFailed \li
     * GeneralError \li HostMemory \li OK
     * @return true on success, false otherwise
     */
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li FunctionFailed \li GeneralError \li HostMemory \li OK
     * @return true on success, false otherwise
     */
    bool C_GetSlotList(Bbool token_present, SlotId *slot_list_ptr, Ulong *count_ptr,
     ...
     * @return true on success, false otherwise
     */
    bool C_GetSlotList(bool token_present, std::vector<SlotId> &slot_ids,
                       ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SlotIdInvalid
     * @return true on success, false otherwise
     */
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SlotIdInvalid \li TokenNotPresent \li TokenNotRecognized \li ArgumentsBad
     * @return true on success, false otherwise
     */
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li FunctionFailed \li GeneralError \li HostMemory \li NoEvent \li OK
     * @return true on success, false otherwise
     */
    bool C_WaitForSlotEvent(Flags flags, SlotId *slot_ptr, VoidPtr reserved,
                            ReturnValue *return_value = ThrowException) const;
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li BufferTooSmall \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li SlotIdInvalid \li TokenNotPresent \li TokenNotRecognized \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_GetMechanismList(SlotId slot_id, MechanismType *mechanism_list_ptr, Ulong *count_ptr,
                            ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_GetMechanismList(SlotId slot_id, std::vector<MechanismType> &mechanisms,
                            ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li
     * MechanismInvalid \li OK \li SlotIdInvalid \li TokenNotPresent \li TokenNotRecognized \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_GetMechanismInfo(SlotId slot_id, MechanismType type, MechanismInfo *info_ptr,
                            ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li PinIncorrect \li PinLocked \li SessionExists \li SlotIdInvalid \li TokenNotPresent \li
     * TokenNotRecognized \li TokenWriteProtected \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_InitToken(SlotId slot_id, Utf8Char *so_pin_ptr, Ulong so_pin_len, Utf8Char *label_ptr,
                     ReturnValue *return_value = ThrowException) const;
    ...
    bool C_InitToken(SlotId slot_id, const std::vector<uint8_t, TAlloc> &so_pin, const std::string &label,
                     ReturnValue *return_value = ThrowException) const
    {
        ...
        return C_InitToken(slot_id, reinterpret_cast<Utf8Char *>(const_cast<uint8_t *>(so_pin.data())),
                           ...
                           reinterpret_cast<Utf8Char *>(const_cast<char *>(padded_label.c_str())), return_value);
    }
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li PinInvalid \li PinLenRange \li SessionClosed \li SessionReadOnly \li SessionHandleInvalid
     * \li TokenWriteProtected \li UserNotLoggedIn \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_InitPIN(SessionHandle session, Utf8Char *pin_ptr, Ulong pin_len,
                   ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_InitPIN(SessionHandle session, const std::vector<uint8_t, TAlloc> &pin,
                   ReturnValue *return_value = ThrowException) const
    {
        return C_InitPIN(session, reinterpret_cast<Utf8Char *>(const_cast<uint8_t *>(pin.data())),
                         static_cast<Ulong>(pin.size()), return_value);
    }
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li PinIncorrect \li PinInvalid \li PinLenRange \li PinLocked \li SessionClosed \li
     * SessionHandleInvalid \li SessionReadOnly \li TokenWriteProtected \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_SetPIN(SessionHandle session, Utf8Char *old_pin_ptr, Ulong old_len, Utf8Char *new_pin_ptr, Ulong new_len,
                  ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_SetPIN(SessionHandle session, const std::vector<uint8_t, TAlloc> &old_pin,
                  const std::vector<uint8_t, TAlloc> &new_pin, ReturnValue *return_value = ThrowException) const
    {
        return C_SetPIN(session, reinterpret_cast<Utf8Char *>(const_cast<uint8_t *>(old_pin.data())),
                        static_cast<Ulong>(old_pin.size()),
                        reinterpret_cast<Utf8Char *>(const_cast<uint8_t *>(new_pin.data())),
                        static_cast<Ulong>(new_pin.size()), return_value);
    }
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SessionCount \li SessionParallelNotSupported \li SessionReadWriteSoExists \li SlotIdInvalid \li TokenNotPresent
     * \li TokenNotRecognized \li TokenWriteProtected \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_OpenSession(SlotId slot_id, Flags flags, VoidPtr application, Notify notify, SessionHandle *session_ptr,
                       ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SlotIdInvalid \li TokenNotPresent
     * @return true on success, false otherwise
     */
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SessionClosed \li SessionHandleInvalid \li ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_GetSessionInfo(SessionHandle session, SessionInfo *info_ptr,
                          ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li BufferTooSmall \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li SessionHandleInvalid \li StateUnsaveable \li
     * ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_GetOperationState(SessionHandle session, Byte *operation_state_ptr, Ulong *operation_state_len_ptr,
                             ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li KeyChanged
     * \li KeyNeeded \li KeyNotNeeded \li OK \li SavedStateInvalid \li SessionClosed \li SessionHandleInvalid \li
     * ArgumentsBad
     * @return true on success, false otherwise
     */
    bool C_SetOperationState(SessionHandle session, Byte *operation_state_ptr, Ulong operation_state_len,
                             ObjectHandle encryption_key, ObjectHandle authentication_key,
                             ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li PinIncorrect \li PinLocked \li
     * SessionClosed \li SessionHandleInvalid \li SessionReadOnlyExists \li UserAlreadyLoggedIn \li
     * UserAnotherAlreadyLoggedIn \li UserPinNotInitialized \li UserTooManyTypes \li UserTypeInvalid
     * @return true on success, false otherwise
     */
    bool C_Login(SessionHandle session, UserType user_type, Utf8Char *pin_ptr, Ulong pin_len,
                 ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_Login(SessionHandle session, UserType user_type, const std::vector<uint8_t, TAlloc> &pin,
                 ReturnValue *return_value = ThrowException) const
    {
        return C_Login(session, user_type, reinterpret_cast<Utf8Char *>(const_cast<uint8_t *>(pin.data())),
                       static_cast<Ulong>(pin.size()), return_value);
    }
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * SessionClosed \li SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li AttributeReadOnly
     * \li AttributeTypeInvalid \li AttributeValueInvalid \li CryptokiNotInitialized \li CurveNotSupported \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li DomainParamsInvalid \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li PinExpired \li SessionClosed \li SessionHandleInvalid \li SessionReadOnly \li
     * TemplateIncomplete \li TemplateInconsistent \li TokenWriteProtected \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_CreateObject(SessionHandle session, Attribute *attribute_template_ptr, Ulong count, ObjectHandle *object_ptr,
                        ReturnValue *return_value = ThrowException) const;
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ActionProhibited \li ArgumentsBad
     * \li AttributeReadOnly \li AttributeTypeInvalid \li AttributeValueInvalid \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li
     * ObjectHandleInvalid \li OK \li PinExpired \li SessionClosed \li SessionHandleInvalid \li SessionReadOnly \li
     * TemplateInconsistent \li TokenWriteProtected \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_CopyObject(SessionHandle session, ObjectHandle object, Attribute *attribute_template_ptr, Ulong count,
                      ObjectHandle *new_object_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ActionProhibited \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li
     * HostMemory \li ObjectHandleInvalid \li OK \li PinExpired \li SessionClosed \li SessionHandleInvalid \li
     * SessionReadOnly \li TokenWriteProtected
     * @return true on success, false otherwise
     */
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li
     * HostMemory \li InformationSensitive \li ObjectHandleInvalid \li OK \li SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_GetObjectSize(SessionHandle session, ObjectHandle object, Ulong *size_ptr,
                         ReturnValue *return_value = ThrowException) const;
     ...
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li AttributeSensitive
     * \li AttributeTypeInvalid \li BufferTooSmall \li CryptokiNotInitialized \li DeviceError \li DeviceMemory \li
     * DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li ObjectHandleInvalid \li OK \li SessionClosed
     * \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_GetAttributeValue(SessionHandle session, ObjectHandle object, Attribute *attribute_template_ptr, Ulong count,
                             ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_GetAttributeValue(SessionHandle session, ObjectHandle object,
                             ...
                             ReturnValue *return_value = ThrowException) const
    {
        ...
        bool success = C_GetAttributeValue(session, object, const_cast<Attribute *>(getter_template.data()),
                                           static_cast<Ulong>(getter_template.size()), return_value);
        ...
        return C_GetAttributeValue(session, object, const_cast<Attribute *>(getter_template.data()),
                                   static_cast<Ulong>(getter_template.size()), return_value);
    }
     ...
     * \li AttributeReadOnly \li AttributeTypeInvalid \li AttributeValueInvalid \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li
     * ObjectHandleInvalid \li OK \li SessionClosed \li SessionHandleInvalid \li SessionReadOnly \li
     * TemplateInconsistent \li TokenWriteProtected \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_SetAttributeValue(SessionHandle session, ObjectHandle object, Attribute *attribute_template_ptr, Ulong count,
                             ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_SetAttributeValue(SessionHandle session, ObjectHandle object,
                             std::map<AttributeType, std::vector<uint8_t, TAlloc>> &attribute_values,
                             ReturnValue *return_value = ThrowException) const
    {
        ...
        for (auto &entry : attribute_values)
        {
            setter_template.emplace_back(Attribute{static_cast<CK_ATTRIBUTE_TYPE>(entry.first), entry.second.data(),
                                                   static_cast<CK_ULONG>(entry.second.size())});
        }

        return C_SetAttributeValue(session, object, const_cast<Attribute *>(setter_template.data()),
                                   static_cast<Ulong>(setter_template.size()), return_value);
    }
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * AttributeTypeInvalid \li AttributeValueInvalid \li CryptokiNotInitialized \li DeviceError \li DeviceMemory \li
     * DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationActive \li PinExpired \li
     * SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_FindObjectsInit(SessionHandle session, Attribute *attribute_template_ptr, Ulong count,
                           ReturnValue *return_value = ThrowException) const;

    /**
     * C_FindObjects continues a search for token and session objects that match a template, obtaining additional object
     * handles.
     * @param session session's handle
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_FindObjects(SessionHandle session, ObjectHandle *object_ptr, Ulong max_object_count, Ulong *object_count_ptr,
                       ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * OperationNotInitialized \li SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li KeyFunctionNotPermitted \li KeyHandleInvalid \li KeySizeRange \li KeyTypeInconsistent \li
     * MechanismInvalid \li MechanismParamInvalid \li OK \li OperationActive \li PinExpired \li SessionClosed \li
     * SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_EncryptInit(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle key,
                       ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li DataInvalid \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li
     * FunctionCanceled \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li
     * SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_Encrypt(SessionHandle session, Byte *data_ptr, Ulong data_len, Byte *encrypted_data,
                   Ulong *encrypted_data_len_ptr, ReturnValue *return_value = ThrowException) const;
    ...
    bool C_Encrypt(SessionHandle session, const std::vector<uint8_t, TAllocA> &plaintext_data,
                   std::vector<uint8_t, TAllocB> &encrypted_data, ReturnValue *return_value = ThrowException) const
    {
        Ulong encrypted_size = 0;
        if (!C_Encrypt(session, const_cast<Byte *>((plaintext_data.data())), static_cast<Ulong>(plaintext_data.size()),
                       nullptr, &encrypted_size, return_value))
        {
            return false;
        }
        ...
        if (!C_Encrypt(session, const_cast<Byte *>(plaintext_data.data()), static_cast<Ulong>(plaintext_data.size()),
                       encrypted_data.data(), &encrypted_size, return_value))
        {
            return false;
        }
        encrypted_data.resize(encrypted_size);
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled
     * \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li
     * SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_EncryptUpdate(SessionHandle session, Byte *part_ptr, Ulong part_len, Byte *encrypted_part_ptr,
                         Ulong *encrypted_part_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_EncryptFinal(SessionHandle session, Byte *last_encrypted_part_ptr, Ulong *last_encrypted_part_len_ptr,
                        ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li KeyFunctionNotPermitted \li KeyHandleInvalid \li KeySizeRange \li
     * KeyTypeInconsistent \li MechanismInvalid \li MechanismParamInvalid \li OK \li OperationActive \li PinExpired \li
     * SessionClosed \li SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_DecryptInit(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle key,
                       ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li EncryptedDataInvalid \li
     * EncryptedDataLenRange \li FunctionCanceled \li FunctionFailed \li GeneralError \li HostMemory \li OK \li
     * OperationNotInitialized \li SessionClosed \li SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_Decrypt(SessionHandle session, Byte *encrypted_data_ptr, Ulong encrypted_data_len, Byte *data_ptr,
                   Ulong *data_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAllocA, typename TAllocB>
    bool C_Decrypt(SessionHandle session, const std::vector<uint8_t, TAllocA> &encrypted_data,
                   std::vector<uint8_t, TAllocB> &decrypted_data, ReturnValue *return_value = ThrowException) const
    {
        Ulong decrypted_size = 0;
        if (!C_Decrypt(session, const_cast<Byte *>((encrypted_data.data())), static_cast<Ulong>(encrypted_data.size()),
                       nullptr, &decrypted_size, return_value))
        {
            return false;
        }
        ...
        if (!C_Decrypt(session, const_cast<Byte *>(encrypted_data.data()), static_cast<Ulong>(encrypted_data.size()),
                       decrypted_data.data(), &decrypted_size, return_value))
        {
            return false;
        }
        decrypted_data.resize(decrypted_size);
     ...
     * @return true on success, false otherwise
     */
    bool C_DecryptUpdate(SessionHandle session, Byte *encrypted_part_ptr, Ulong encrypted_part_len, Byte *part_ptr,
                         Ulong *part_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_DecryptFinal(SessionHandle session, Byte *last_part_ptr, Ulong *last_part_len_ptr,
                        ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li MechanismInvalid \li MechanismParamInvalid \li OK \li OperationActive \li
     * PinExpired \li SessionClosed \li SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_DigestInit(SessionHandle session, Mechanism *mechanism_ptr,
                      ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_Digest(SessionHandle session, Byte *data_ptr, Ulong data_len, Byte *digest_ptr, Ulong *digest_len_ptr,
                  ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_DigestUpdate(SessionHandle session, Byte *part_ptr, Ulong part_len,
                        ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li KeyHandleInvalid \li KeyIndigestible \li KeySizeRange \li OK \li OperationNotInitialized \li
     * SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
     ...
     * @return true on success, false otherwise
     */
    bool C_DigestFinal(SessionHandle session, Byte *digest_ptr, Ulong *digest_len_ptr,
                       ReturnValue *return_value = ThrowException) const;

    /****************************** Signing and MACing functions ******************************/

    /**
     * C_SignInit initializes a signature (private key encryption) operation, where the signature is (will be) an
     ...
     * @return true on success, false otherwise
     */
    bool C_SignInit(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle key,
                    ReturnValue *return_value = ThrowException) const;

    /**
     * C_Sign signs (encrypts with private key) data in a single part, where the signature is (will be) an appendix to
     ...
     * CryptokiNotInitialized \li DataInvalid \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li
     * FunctionCanceled \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li
     * SessionClosed \li SessionHandleInvalid \li UserNotLoggedIn \li FunctionRejected
     * @return true on success, false otherwise
     */
    bool C_Sign(SessionHandle session, Byte *data_ptr, Ulong data_len, Byte *signature_ptr, Ulong *signature_len_ptr,
                ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAllocA, typename TAllocB>
    bool C_Sign(SessionHandle session, const std::vector<uint8_t, TAllocA> &data,
                std::vector<uint8_t, TAllocB> &signature, ReturnValue *return_value = ThrowException) const
    {
        Ulong signature_size = 0;
        if (!C_Sign(session, const_cast<Byte *>((data.data())), static_cast<Ulong>(data.size()), nullptr,
                    &signature_size, return_value))
        {
            return false;
        }

        signature.resize(signature_size);
        if (!C_Sign(session, const_cast<Byte *>(data.data()), static_cast<Ulong>(data.size()), signature.data(),
                    &signature_size, return_value))
        {
            return false;
        }
    ...
    /**
     * C_SignUpdate continues a multiple-part signature operation, where the signature is (will be) an appendix to the
     ...
     * @return true on success, false otherwise
     */
    bool C_SignUpdate(SessionHandle session, Byte *part_ptr, Ulong part_len,
                      ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_SignUpdate(SessionHandle session, const std::vector<uint8_t, TAlloc> &part,
                      ReturnValue *return_value = ThrowException) const
    {
        return C_SignUpdate(session, const_cast<Byte *>(part.data()), static_cast<Ulong>(part.size()), return_value);
    }
     ...
     * CryptokiNotInitialized \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled
     * \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li
     * SessionHandleInvalid \li UserNotLoggedIn \li FunctionRejected
     * @return true on success, false otherwise
     */
    bool C_SignFinal(SessionHandle session, Byte *signature_ptr, Ulong *signature_len_ptr,
                     ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_SignFinal(SessionHandle session, std::vector<uint8_t, TAlloc> &signature,
                     ReturnValue *return_value = ThrowException) const
    {
        Ulong signature_size = 0;
     ...
     * @return true on success, false otherwise
     */
    bool C_SignRecoverInit(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle key,
                           ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_SignRecover(SessionHandle session, Byte *data_ptr, Ulong data_len, Byte *signature_ptr,
                       Ulong *signature_len_ptr, ReturnValue *return_value = ThrowException) const;

    /****************************** Functions for verifying signatures and MACs ******************************/

    /**
     * C_VerifyInit initializes a verification operation, where the signature is an appendix to the data, and plaintext
     ...
     * @return true on success, false otherwise
     */
    bool C_VerifyInit(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle key,
                      ReturnValue *return_value = ThrowException) const;

    /**
     * C_Verify verifies a signature in a single-part operation, where the signature is an appendix to the data, and
     ...
     * CryptokiNotInitialized \li DataInvalid \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li
     * FunctionCanceled \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li
     * SessionClosed \li SessionHandleInvalid \li SignatureInvalid \li SignatureLenRange
     * @return true on success, false otherwise
     */
    bool C_Verify(SessionHandle session, Byte *data_ptr, Ulong data_len, Byte *signature_ptr, Ulong signature_len,
                  ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAllocA, typename TAllocB>
    bool C_Verify(SessionHandle session, const std::vector<uint8_t, TAllocA> &data,
                  std::vector<uint8_t, TAllocB> &signature, ReturnValue *return_value = ThrowException) const
    {
        return C_Verify(session, const_cast<Byte *>(data.data()), static_cast<Ulong>(data.size()), signature.data(),
                        static_cast<Ulong>(signature.size()), return_value);
    }

    /**
     * C_VerifyUpdate continues a multiple-part verification operation, where the signature is an appendix to the data,
     ...
     * @return true on success, false otherwise
     */
    bool C_VerifyUpdate(SessionHandle session, Byte *part_ptr, Ulong part_len,
                        ReturnValue *return_value = ThrowException) const;
     ...
     */
    template <typename TAlloc>
    bool C_VerifyUpdate(SessionHandle session, std::vector<uint8_t, TAlloc> part,
                        ReturnValue *return_value = ThrowException) const
    {
     ...
     * CryptokiNotInitialized \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled
     * \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li
     * SessionHandleInvalid \li SignatureInvalid \li SignatureLenRange
     * @return true on success, false otherwise
     */
    bool C_VerifyFinal(SessionHandle session, Byte *signature_ptr, Ulong signature_len,
                       ReturnValue *return_value = ThrowException) const;

    /**
     * C_VerifyRecoverInit initializes a signature verification operation, where the data is recovered from the
     * signature.
     * @param session the session's handle
     * @param mechanism_ptr the verification mechanism
     * @param key verification key
     ...
     * @return true on success, false otherwise
     */
    bool C_VerifyRecoverInit(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle key,
                             ReturnValue *return_value = ThrowException) const;
     ...
     * CryptokiNotInitialized \li DataInvalid \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li
     * FunctionCanceled \li FunctionFailed \li GeneralError \li HostMemory \li OK \li OperationNotInitialized \li
     * SessionClosed \li SessionHandleInvalid \li SignatureLenRange \li SignatureInvalid
     * @return true on success, false otherwise
     */
    bool C_VerifyRecover(SessionHandle session, Byte *signature_ptr, Ulong signature_len, Byte *data_ptr,
                         Ulong *data_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_DigestEncryptUpdate(SessionHandle session, Byte *part_ptr, Ulong part_len, Byte *encrypted_part_ptr,
                               Ulong *encrypted_part_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_DecryptDigestUpdate(SessionHandle session, Byte *encrypted_part_ptr, Ulong encrypted_part_len,
                               Byte *part_ptr, Ulong *part_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_SignEncryptUpdate(SessionHandle session, Byte *part_ptr, Ulong part_len, Byte *encrypted_part_ptr,
                             Ulong *encrypted_part_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li DataLenRange \li DeviceError \li DeviceMemory \li DeviceRemoved \li
     * EncryptedDataInvalid \li EncryptedDataLenRange \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li OK \li OperationNotInitialized \li SessionClosed \li SessionHandleInvalid
     * @return true on success, false otherwise
     */
    bool C_DecryptVerifyUpdate(SessionHandle session, Byte *encrypted_part_ptr, Ulong encrypted_part_len,
                               Byte *part_ptr, Ulong *part_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * \li AttributeTypeInvalid \li AttributeValueInvalid \li CryptokiNotInitialized \li CurveNotSupported \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed \li GeneralError \li
     * HostMemory \li MechanismInvalid \li MechanismParamInvalid \li OK \li OperationActive \li PinExpired \li
     * SessionClosed \li SessionHandleInvalid \li SessionReadOnly \li TemplateIncomplete \li TemplateInconsistent \li
     * TokenWriteProtected \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_GenerateKey(SessionHandle session, Mechanism *mechanism_ptr, Attribute *attribute_template_ptr, Ulong count,
                       ObjectHandle *key_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li AttributeReadOnly
     * \li AttributeTypeInvalid \li AttributeValueInvalid \li CryptokiNotInitialized \li CurveNotSupported \li
     * DeviceError \li DeviceMemory \li DeviceRemoved \li DomainParamsInvalid \li FunctionCanceled \li FunctionFailed
     ...
     * @return true on success, false otherwise
     */
    bool C_GenerateKeyPair(SessionHandle session, Mechanism *mechanism_ptr, Attribute *public_key_template_ptr,
                           Ulong public_key_attribute_count, Attribute *private_key_template_ptr,
                           Ulong private_key_attribute_count, ObjectHandle *public_key_ptr,
                           ObjectHandle *private_key_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li BufferTooSmall \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li KeyHandleInvalid \li KeyNotWrappable \li KeySizeRange \li KeyUnextractable
     * \li MechanismInvalid \li MechanismParamInvalid \li OK \li OperationActive \li PinExpired \li SessionClosed \li
     * SessionHandleInvalid \li UserNotLoggedIn \li WrappingKeyHandleInvalid \li WrappingKeySizeRange \li
     * WrappingKeyTypeInconsistent
     * @return true on success, false otherwise
     */
    bool C_WrapKey(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle wrapping_key, ObjectHandle key,
                   Byte *wrapped_key_ptr, Ulong *wrapped_key_len_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li AttributeReadOnly
     * \li AttributeTypeInvalid \li AttributeValueInvalid \li BufferTooSmall \li CryptokiNotInitialized \li
     * CurveNotSupported \li DeviceError \li DeviceMemory \li DeviceRemoved \li DomainParamsInvalid \li FunctionCanceled
     ...
     * @return true on success, false otherwise
     */
    bool C_UnwrapKey(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle unwrapping_key,
                     Byte *wrapped_key_ptr, Ulong wrapped_key_len, Attribute *attribute_template_ptr,
                     Ulong attribute_count, ObjectHandle *key_ptr, ReturnValue *return_value = ThrowException) const;
     ...
     * @return true on success, false otherwise
     */
    bool C_DeriveKey(SessionHandle session, Mechanism *mechanism_ptr, ObjectHandle base_key,
                     Attribute *attribute_template_ptr, Ulong attribute_count, ObjectHandle *key_ptr,
                     ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li OK \li OperationActive \li RandomSeedNotSupported \li RandomNoRng \li
     * SessionClosed \li SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_SeedRandom(SessionHandle session, Byte *seed_ptr, Ulong seed_len,
                      ReturnValue *return_value = ThrowException) const;
     ...
     * is thrown. At least the following PKCS#11 return values may be returned: \li ArgumentsBad \li
     * CryptokiNotInitialized \li DeviceError \li DeviceMemory \li DeviceRemoved \li FunctionCanceled \li FunctionFailed
     * \li GeneralError \li HostMemory \li OK \li OperationActive \li RandomNoRng \li SessionClosed \li
     * SessionHandleInvalid \li UserNotLoggedIn
     * @return true on success, false otherwise
     */
    bool C_GenerateRandom(SessionHandle session, Byte *random_data_ptr, Ulong random_len,
                          ReturnValue *return_value = ThrowException) const;

    /****************************** Parallel function management functions ******************************/

    /**
     * C_GetFunctionStatus is a legacy function; it obtains an updated status of a function running in parallel with an
     * application.
     * @param session the session's handle
     * @param return_value default value (`ThrowException`): throw exception on error.
     * if a non-NULL pointer is passed: return_value receives the return value of the PKCS#11 function and no exception
     * is thrown. At least the following PKCS#11 return values may be returned: \li CryptokiNotInitialized \li
     * FunctionFailed \li FunctionNotParallel \li GeneralError \li HostMemory \li SessionHandleInvalid \li SessionClosed
     * @return true on success, false otherwise
     */
...
{
  public:
    explicit PKCS11_Error(const std::string &what) : Exception("PKCS11 error", what)
    {
    }
