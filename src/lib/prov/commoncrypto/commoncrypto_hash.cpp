...
template <class CTX> class CommonCrypto_HashFunction final : public HashFunction
{
  public:
...
#define MAKE_COMMONCRYPTO_HASH_3(name, hash, ctx)                                                                      \
    std::unique_ptr<HashFunction>(                                                                                     \
        new CommonCrypto_HashFunction<CC_##ctx##_CTX>({name, CC_##hash##_DIGEST_LENGTH, CC_##hash##_BLOCK_BYTES,       \
                                                       CC_##hash##_Init, CC_##hash##_Update, CC_##hash##_Final}));
