...
// static
std::unique_ptr<Compression_Algorithm> Compression_Algorithm::create(const std::string &algo)
{
...
// static
std::unique_ptr<Compression_Algorithm> Compression_Algorithm::create_or_throw(const std::string &algo)
{
...
// static
std::unique_ptr<Decompression_Algorithm> Decompression_Algorithm::create(const std::string &algo)
{
...
// static
std::unique_ptr<Decompression_Algorithm> Decompression_Algorithm::create_or_throw(const std::string &algo)
{
