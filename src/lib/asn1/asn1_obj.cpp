 ...
 */
void BER_Object::assert_is_a(ASN1_Tag expected_type_tag, ASN1_Tag expected_class_tag, const std::string &descr) const
{
...
BER_Bad_Tag::BER_Bad_Tag(const std::string &str, ASN1_Tag tag) : BER_Decoding_Error(str + ": " + std::to_string(tag))
{
}
