...
class CFB_Encryption final : public CFB_Mode
{
  public:
     ...
     */
    CFB_Encryption(BlockCipher *cipher, size_t feedback_bits) : CFB_Mode(cipher, feedback_bits)
    {
    }
...
class CFB_Decryption final : public CFB_Mode
{
  public:
     ...
     * must be a multiple of 8
     */
    CFB_Decryption(BlockCipher *cipher, size_t feedback_bits) : CFB_Mode(cipher, feedback_bits)
    {
    }
