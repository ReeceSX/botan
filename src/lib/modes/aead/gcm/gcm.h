...
class GCM_Encryption final : public GCM_Mode
{
  public:
     ...
     */
    GCM_Encryption(BlockCipher *cipher, size_t tag_size = 16) : GCM_Mode(cipher, tag_size)
    {
    }
...
class GCM_Decryption final : public GCM_Mode
{
  public:
     ...
     * @param tag_size is how big the auth tag will be
     */
    GCM_Decryption(BlockCipher *cipher, size_t tag_size = 16) : GCM_Mode(cipher, tag_size)
    {
    }
