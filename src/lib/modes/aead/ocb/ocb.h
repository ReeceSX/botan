...
class BOTAN_TEST_API OCB_Encryption final : public OCB_Mode
{
  public:
     ...
     * @param tag_size is how big the auth tag will be
     */
    OCB_Encryption(BlockCipher *cipher, size_t tag_size = 16) : OCB_Mode(cipher, tag_size)
    {
    }
...
class BOTAN_TEST_API OCB_Decryption final : public OCB_Mode
{
  public:
     ...
     * @param tag_size is how big the auth tag will be
     */
    OCB_Decryption(BlockCipher *cipher, size_t tag_size = 16) : OCB_Mode(cipher, tag_size)
    {
    }
