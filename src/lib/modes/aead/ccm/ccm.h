...
class CCM_Encryption final : public CCM_Mode
{
  public:
     ...
     */
    CCM_Encryption(BlockCipher *cipher, size_t tag_size = 16, size_t L = 3) : CCM_Mode(cipher, tag_size, L)
    {
    }
...
class CCM_Decryption final : public CCM_Mode
{
  public:
     ...
     *           must be less than 2**L bytes, and the nonce is 15-L bytes.
     */
    CCM_Decryption(BlockCipher *cipher, size_t tag_size = 16, size_t L = 3) : CCM_Mode(cipher, tag_size, L)
    {
    }
