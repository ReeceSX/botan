...
class EAX_Encryption final : public EAX_Mode
{
  public:
     ...
     * @param tag_size is how big the auth tag will be
     */
    EAX_Encryption(BlockCipher *cipher, size_t tag_size = 0) : EAX_Mode(cipher, tag_size)
    {
    }
...
class EAX_Decryption final : public EAX_Mode
{
  public:
     ...
     * @param tag_size is how big the auth tag will be
     */
    EAX_Decryption(BlockCipher *cipher, size_t tag_size = 0) : EAX_Mode(cipher, tag_size)
    {
    }
